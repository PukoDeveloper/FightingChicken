 ...
 * ```
 */
export function parseDialogueMarkup(raw) {
    if (!raw)
        return EMPTY_PARSED;
    let plain = '';
    const colorSpans = [];
 ...
 */
export function getSpeedAtIndex(charIndex, speedSpans, defaultSpeed) {
...
//# sourceMappingURL=DialogueMarkupParser.js.map