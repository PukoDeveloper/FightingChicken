...
export class EntityManager {
    ...
    editorMeta = {
        ...
        events: ['entity/create', 'entity/destroy', 'entity/query'],
    };
    _core = null;
    ...
    init(core) {
        ...
        const result = core.events.emitSync('renderer/layer', { name: 'world' });
        ...
        // ── EventBus public API ────────────────────────────────────────────
        core.events.on(this.namespace, 'entity/create', (params, output) => {
            output.entity = this.create(params);
        });
        core.events.on(this.namespace, 'entity/destroy', (params) => {
            this.destroyById(params.id);
        });
        core.events.on(this.namespace, 'entity/query', (params, output) => {
    ...
    query(params = {}) {
        ...
        if (params.rect) {
            ...
            results = results.filter(e => e.position.x >= x &&
