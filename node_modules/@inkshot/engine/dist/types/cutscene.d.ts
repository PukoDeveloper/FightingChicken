...
export type CutsceneStepKind = 'wait' | 'camera-move' | 'camera-zoom' | 'camera-shake' | 'camera-follow' | 'emit' | 'script' | 'lock-input' | 'unlock-input' | 'parallel';
...
export type CutsceneStep = CutsceneStepWait | CutsceneStepCameraMove | CutsceneStepCameraZoom | CutsceneStepCameraShake | CutsceneStepCameraFollow | CutsceneStepEmit | CutsceneStepScript | CutsceneStepLockInput | CutsceneStepUnlockInput | CutsceneStepParallel;
