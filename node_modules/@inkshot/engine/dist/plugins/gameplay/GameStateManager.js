...
export class GameStateManager {
    ...
    editorMeta = {
        ...
        events: ['game/state:set', 'game/state:get'],
    };
    _state = 'none';
    // ---------------------------------------------------------------------------
    ...
    init(core) {
        const { events } = core;
        events.on(this.namespace, 'game/state:set', (params) => {
            this._state = params.state;
        });
        events.on(this.namespace, 'game/state:get', (_params, output) => {
        ...
        events.on(this.namespace, 'save/slot:load', async (_params, output) => {
            if (!output.loaded)
                return;
            this._reset();
            this._state = 'playing';
