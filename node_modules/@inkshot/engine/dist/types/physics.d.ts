 ...
 */
export declare const CollisionLayer: {
 ...
 */
export type TileCollisionShape = 'solid' | 'empty' | 'top-only' | 'slope-ne' | 'slope-nw' | 'slope-se' | 'slope-sw';
/**
 ...
 */
export type TileShapeResolver = (shape: string, ctx: TileShapeContext) => {
    blocked: boolean;
    resolved: number;
} | null;
