...
const DIALOGUE: DialogueLine[] = [
  {
    ...
    text: '小雞……你感覺到了嗎？星空在顫抖。這裡的黑暗比我們見過的任何東西都要濃烈。',
    side: 'right',
  },
  {
    speaker: '小雞',
    ...
    text: '祖父說往星空深處的漩渦走。那個漩渦……就在前方。',
    side: 'left',
  },
  {
    speaker: '混沌',
    portraitFactory: createChaosDisplay,
    accentColor: 0xcc44ff,
    text: '……哈哈哈哈。終於來了。我等你們已經很久了，小雞。',
    side: 'right',
  },
  {
    speaker: '小雞',
  ...
  },
  {
    ...
    portraitFactory: createChaosDisplay,
    accentColor: 0xcc44ff,
    text: '關？不不不。你的祖父是我的貴客。他的智慧是如此珍貴——我只是借用了一點時間。',
    side: 'right',
  },
  {
    speaker: '勇氣',
  ...
  },
  {
    ...
    portraitFactory: createChaosDisplay,
    accentColor: 0xcc44ff,
    text: '勇氣……連你也來了？有趣。那就讓我看看——你們的意志究竟有多強！',
    side: 'right',
  },
  {
    speaker: '祖父的聲音',
  ...
  },
  {
    ...
    portraitFactory: createChickenDisplay,
    accentColor: 0x66aaff,
    text: '祖父！我聽到你了！——混沌，今天我就用心中的光，把你徹底擊碎！',
    side: 'left',
  },
];
...
async function enter(core: Core): Promise<void> {
  ...
  const titleCardTitle = new Text({
    ...
    style: new TextStyle({
      ...
      fontWeight: 'bold',
      fill: 0xffffff,
      dropShadow: { color: 0x8800cc, distance: 2, alpha: 0.7, blur: 4 },
    }),
  });
  ...
  // ── Tick: blink tap hint ────────────────────────────────────────────────────
  const unsubTick = core.events.on('story_ch4', 'core/tick', () => {
    if (!advanceLocked) {
  ...
  _cleanup = () => {
    ...
    core.events.removeNamespace('story_ch4');
    unsubTick();
...
export const StoryChapter4Scene: SceneDescriptor = {
  key: 'story_ch4',
  enter,
  exit,
};
