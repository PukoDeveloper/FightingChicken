 ...
 * ```
 */
export type UIWidgetFactory<P extends Record<string, unknown> = Record<string, unknown>> = (id: string, props: P, core: Core) => UIWidget;
/**
 ...
 * ```
 */
export type UIAnchor = 'top-left' | 'top-center' | 'top-right' | 'middle-left' | 'middle-center' | 'middle-right' | 'bottom-left' | 'bottom-center' | 'bottom-right';
/**
